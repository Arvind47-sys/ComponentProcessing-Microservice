    ...
    public class AccessoryPartProcessingBLO : IAccessoryPartProcessingBLO
    {
            ...
            ProcessingChargeAndDurationDetails processingChargeAndDurationDetails)
        {
            return new ProcessResponseDto
            {
                ...
                ProcessingCharge = Convert.ToDouble(processingChargeAndDurationDetails.ChargeForAccessoryPart) * processRequest.Quantity,
                DateOfDelivery = DateTime.Now.AddDays(Convert.ToInt32(processingChargeAndDurationDetails.DurationForAccessoryPart) * processRequest.Quantity),
